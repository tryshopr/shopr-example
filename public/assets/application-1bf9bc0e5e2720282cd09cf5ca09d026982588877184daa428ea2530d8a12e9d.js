...
(function() {
  jQuery(function() {
    $(".comment-form").on("ajax:beforeSend", function(evt, xhr, settings) {
      ...
      $(this).find('input[type=text], textarea').removeClass('uneditable-input').removeAttr('disabled', 'disabled').val('');
    ...
    return $('.add-comment').on('click', function(e) {
      ...
      return $(e.target).attr('disabled', 'disabled');
    });
  });
...
(function() {
  jQuery(function() {
    var qweqw;
    $("select#product_variants").on("change", function(e) {
      return qweqw(e);
    });
    qweqw = function(e) {
      var $productRow, $target, url, variant;
      $target = $(e.target);
      variant = $target.val();
      ...
      return $.ajax({
        ...
        success: function(result) {
          ...
          return $("select#product_variants").on("change", function(e) {
            return qweqw(e);
          });
        }
      });
    };
    $("select#product_cat_variants").on("change", function(e) {
      return qweqw(e);
    });
    qweqw = function(e) {
      var $productRow, $target, url, variant;
    ...
    $('.to-review-anchor').on('click', function() {
      return $('#reviews').click();
    });
    return $('.to-review-btn-anchor').on('click', function() {
      $('#reviews').click();
      return $('.btn.add-comment').click();
    });
  });
