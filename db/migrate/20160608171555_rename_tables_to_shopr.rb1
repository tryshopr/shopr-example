class RenameTablesToShopr < ActiveRecord::Migration
  def change
    ...
    # drop_table :shopr_addresses
    # drop_table :shopr_attachments
    # drop_table :shopr_countries
    # drop_table :shopr_customers
    # drop_table :shopr_delivery_service_prices
    # drop_table :shopr_delivery_services
    # drop_table :shopr_order_items
    # drop_table :shopr_orders
    # drop_table :shopr_payments
    # drop_table :shopr_product_attributes
    # drop_table :shopr_product_categories
    # drop_table :shopr_product_categorizations
    # drop_table :shopr_settings
    # drop_table :shopr_stock_level_adjustments
    # drop_table :shopr_tax_rates
    # drop_table :shopr_users
