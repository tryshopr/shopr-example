...
ActiveRecord::Schema.define(version: 20160727192844) do
  ...
  add_index "Shopr_order_items", ["ordered_item_id", "ordered_item_type"], name: "index_Shopr_order_items_ordered_item"
