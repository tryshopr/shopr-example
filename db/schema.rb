...
ActiveRecord::Schema.define(version: 20_160_727_192_844) do
  ...
  create_table 'shopr_comments', force: :cascade do |t|
    t.text 'comment'
  ...
  create_table 'shopr_order_items', force: :cascade do |t|
    ...
    t.index %w[ordered_item_id ordered_item_type], name: 'index_shopr_order_items_ordered_item'
  end
  ...
  create_table 'shopr_stock_level_adjustments', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[item_id item_type], name: 'index_shopr_stock_level_adjustments_items'
    t.index %w[parent_id parent_type], name: 'index_shopr_stock_level_adjustments_parent'
  end
